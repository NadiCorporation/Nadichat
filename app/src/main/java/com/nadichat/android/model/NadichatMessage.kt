...
/**
 * NadichatMessage - 100% compatible with iOS version
 */
@Parcelize
data class NadichatMessage(
    ...
    companion object {
         ...
         */
        fun fromBinaryPayload(data: ByteArray): NadichatMessage? {
            try {
