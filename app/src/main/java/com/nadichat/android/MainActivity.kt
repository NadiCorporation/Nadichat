...
import com.nadichat.android.onboarding.*
import com.nadichat.android.ui.ChatScreen
import com.nadichat.android.ui.ChatViewModel
import com.nadichat.android.ui.theme.NadichatTheme
...
class MainActivity : ComponentActivity() {
    ...
    private fun handleNotificationIntent(intent: Intent) {
        val shouldOpenPrivateChat = intent.getBooleanExtra(
            com.nadichat.android.ui.NotificationManager.EXTRA_OPEN_PRIVATE_CHAT, 
            false
        )
        
        if (shouldOpenPrivateChat) {
            val peerID = intent.getStringExtra(com.nadichat.android.ui.NotificationManager.EXTRA_PEER_ID)
            val senderNickname = intent.getStringExtra(com.nadichat.android.ui.NotificationManager.EXTRA_SENDER_NICKNAME)
