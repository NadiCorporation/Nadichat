...
class BluetoothConnectionManager(
    ...
    private val componentDelegate = object : BluetoothConnectionManagerDelegate {
        override fun onPacketReceived(packet: NadichatPacket, peerID: String, device: BluetoothDevice?) {
...
interface BluetoothConnectionManagerDelegate {
    fun onPacketReceived(packet: NadichatPacket, peerID: String, device: BluetoothDevice?)
