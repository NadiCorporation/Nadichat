package com.nadichat.android.mesh

import android.content.Context
import android.util.Log
import com.nadichat.android.crypto.EncryptionService
import com.nadichat.android.crypto.MessagePadding
import com.nadichat.android.model.NadichatMessage
import com.nadichat.android.model.RoutedPacket
import com.nadichat.android.model.DeliveryAck
import com.nadichat.android.model.ReadReceipt
import com.nadichat.android.protocol.NadichatPacket
import com.nadichat.android.protocol.MessageType
import com.nadichat.android.protocol.SpecialRecipients
...
class BluetoothMeshService(private val context: Context) {
    ...
    private fun setupDelegates() {
        ...
        storeForwardManager.delegate = object : StoreForwardManagerDelegate {
            ...
            override fun sendPacket(packet: NadichatPacket) {
        ...
        messageHandler.delegate = object : MessageHandlerDelegate {
            ...
            override fun verifySignature(packet: NadichatPacket, peerID: String): Boolean {
            ...
            // Callbacks
            override fun onMessageReceived(message: NadichatMessage) {
        ...
        packetProcessor.delegate = object : PacketProcessorDelegate {
            override fun validatePacketSecurity(packet: NadichatPacket, peerID: String): Boolean {
            ...
            override fun handleFragment(packet: NadichatPacket): NadichatPacket? {
        ...
        connectionManager.delegate = object : BluetoothConnectionManagerDelegate {
            override fun onPacketReceived(packet: NadichatPacket, peerID: String, device: android.bluetooth.BluetoothDevice?) {
    ...
    fun sendBroadcastAnnounce() {
        serviceScope.launch {
            ...
            val announcePacket = NadichatPacket(
...
interface BluetoothMeshDelegate {
    fun didReceiveMessage(message: NadichatMessage)
