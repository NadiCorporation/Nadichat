...
class FragmentManager {
     ...
     */
    fun createFragments(packet: NadichatPacket): List<NadichatPacket> {
        ...
        val fragments = mutableListOf<NadichatPacket>()
        ...
        for (i in 0 until totalFragments) {
            ...
            val fragmentPacket = NadichatPacket(
     ...
     */
    fun handleFragment(packet: NadichatPacket): NadichatPacket? {
        ...
        try {
            ...
            if (incomingFragments[fragmentID]?.size == total) {
                ...
                val reassembledPacket = NadichatPacket.fromBinaryData(reassembledData.toByteArray())
...
interface FragmentManagerDelegate {
    fun onPacketReassembled(packet: NadichatPacket)
}
