...
class MessageManager(private val state: ChatState) {
    ...
    fun addMessage(message: NadichatMessage) {
    ...
    fun addChannelMessage(channel: String, message: NadichatMessage) {
    ...
    fun addPrivateMessage(peerID: String, message: NadichatMessage) {
     ...
     */
    fun generateMessageKey(message: NadichatMessage): String {
