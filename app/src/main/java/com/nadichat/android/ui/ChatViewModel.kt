package com.nadichat.android.ui
...
import com.nadichat.android.mesh.BluetoothMeshDelegate
import com.nadichat.android.mesh.BluetoothMeshService
...
/**
 * Refactored ChatViewModel - Main coordinator for Nadichat functionality
...
class ChatViewModel(
    ...
    val messages: LiveData<List<NadichatMessage>> = state.messages
    ...
    val privateChats: LiveData<Map<String, List<NadichatMessage>>> = state.privateChats
    ...
    val channelMessages: LiveData<Map<String, List<NadichatMessage>>> = state.channelMessages
    ...
    private fun loadAndInitialize() {
        ...
        viewModelScope.launch {
            ...
            if (state.getConnectedPeersValue().isEmpty() && state.getMessagesValue().isEmpty()) {
                val welcomeMessage = NadichatMessage(
                    sender = "system",
                    content = "get people around you to download Nadichat…and chat with them here!",
                    timestamp = Date(),
                    isRelay = false
                )
    ...
    override fun didReceiveMessage(message: NadichatMessage) {
