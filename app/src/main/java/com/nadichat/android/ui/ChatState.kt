...
class ChatState {
    ...
    private val _messages = MutableLiveData<List<NadichatMessage>>(emptyList())
    val messages: LiveData<List<NadichatMessage>> = _messages
    ...
    // Private chats
    private val _privateChats = MutableLiveData<Map<String, List<NadichatMessage>>>(emptyMap())
    val privateChats: LiveData<Map<String, List<NadichatMessage>>> = _privateChats
    ...
    private val _channelMessages = MutableLiveData<Map<String, List<NadichatMessage>>>(emptyMap())
    val channelMessages: LiveData<Map<String, List<NadichatMessage>>> = _channelMessages
    ...
    fun setMessages(messages: List<NadichatMessage>) {
    ...
    fun setPrivateChats(chats: Map<String, List<NadichatMessage>>) {
    ...
    fun setChannelMessages(messages: Map<String, List<NadichatMessage>>) {
