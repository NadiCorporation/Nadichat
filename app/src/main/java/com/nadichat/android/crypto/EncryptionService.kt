package com.nadichat.android.crypto
...
class EncryptionService(private val context: Context) {
    ...
    private val prefs: SharedPreferences = context.getSharedPreferences("nadichat_crypto", Context.MODE_PRIVATE)
    ...
    fun addPeerPublicKey(peerID: String, publicKeyData: ByteArray) {
        ...
        val salt = "nadichat-v1".toByteArray()
