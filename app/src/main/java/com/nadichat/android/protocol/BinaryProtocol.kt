package com.nadichat.android.protocol
...
data class NadichatPacket(
    ...
    companion object {
        fun fromBinaryData(data: ByteArray): NadichatPacket? {
...
object BinaryProtocol {
    ...
    fun encode(packet: NadichatPacket): ByteArray? {
        try {
    ...
    fun decode(data: ByteArray): NadichatPacket? {
        try {
