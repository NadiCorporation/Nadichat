...
# Nadichat for Android

A secure, decentralized, peer-to-peer messaging app that works over Bluetooth mesh networks. No internet required, no servers, no phone numbers - just pure encrypted communication.

## Install Nadichat

You can download the latest version of Nadichat for Android from the [GitHub Releases page](https://github.com/NadiCorporation/Nadichat/releases).
...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/NadiCorporation/Nadichat.git
   cd Nadichat
   ```
...
2. **Open in Android Studio:**
   ...
   # Navigate to the Nadichat directory
   ```
...
3. **Launch Nadichat** - it will auto-start mesh networking
4. **Set your nickname** or use the auto-generated one
5. **Connect automatically** to nearby Nadichat users
...
### Binary Protocol
Nadichat uses an efficient binary protocol optimized for Bluetooth LE:
...
1. **NadichatApplication.kt**: Application-level initialization and dependency injection
